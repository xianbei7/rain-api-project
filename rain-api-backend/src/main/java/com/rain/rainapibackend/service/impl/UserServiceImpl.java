...
import com.rain.rainapibackend.model.dto.user.UserQueryRequest;
import com.rain.rainapibackend.model.enums.UserRoleEnum;
import com.rain.rainapibackend.model.vo.LoginUserVO;
import com.rain.rainapibackend.model.vo.UserVO;
import com.rain.rainapibackend.service.UserService;
import com.rain.rainapibackend.utils.SqlUtils;
...
import static com.rain.rainapibackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public LoginUserVO userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        if (user.getUserRole().equals(UserRoleEnum.BAN.getValue())){
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR, "用户已被封号");
        }
        // 3. 记录用户的登录态
